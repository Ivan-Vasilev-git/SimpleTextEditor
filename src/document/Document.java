...
public abstract class Document {
  ...
  protected int countSyllables(String word) {
    ...
    /// TODO: 19.05.2020 analyse differences between my implementation an their
...
//    //System.out.print("Counting syllables in " + word + "...");
  ...
  public double getFleschScore() {
    double fleschScore =
        206.835 - 1.015 * ((double) getNumWords() / getNumSentences()) - (84.6 * ((double) getNumSyllables() / getNumWords()));
    return fleschScore;
  }
